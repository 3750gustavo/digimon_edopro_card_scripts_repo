...
function s.initial_effect(c)
	Fusion.AddProcMix(c,true,true,37501179,37501161)
...
function s.needle(e,tp,eg,ep,ev,re,r,rp)
	 ...
	 if c==atacante then Duel.Destroy(atacado,REASON_EFFECT) end
	 if c==atacado then Duel.Destroy(atacante,REASON_EFFECT) end
end