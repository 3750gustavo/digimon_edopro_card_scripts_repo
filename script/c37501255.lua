...
function s.initial_effect(c)
	Fusion.AddProcMixN(c,true,true,37501250,1,aux.FilterBoolFunction(Card.IsSetCard,0x3763),1)
...
function s.addtg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local alvos=Duel.SelectMatchingCard(tp,s.eggfilter,tp,LOCATION_GRAVE,0,1,2,nil)
