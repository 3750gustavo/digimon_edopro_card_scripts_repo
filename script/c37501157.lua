...
function s.initial_effect(c)
	Fusion.AddProcMixN(c,true,true,37501155,1,aux.FilterBoolFunction(Card.IsSetCard,0x3763),1,37501156,1)
	Fusion.AddProcMixN(c,true,true,37501205,1,aux.FilterBoolFunction(Card.IsSetCard,0x3763),1,37501156,1)
