...
function s.initial_effect(c)
	Fusion.AddProcMix(c,s.digivice,true,37501107,s.digivice)
	Fusion.AddProcMix(c,s.digivice,true,37501160,s.digivice)
...
function s.digivice(c)
	return c:IsCode(37501101) or c:IsCode(37501106)
end
...
--ignorar esse bloco
function s.digivice2(c)
	return c:IsCode(37501106)
end
